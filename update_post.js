...
var button = document.getElementById('update_note');
var lastFocusedElement;
var closeButton = document.querySelector('.close_update');
var closeButton1 = document.querySelector('.no_delete2');
...
function showModal() {
    ...
    var modal = document.getElementById('post_update');
    // Show the window
    modal.classList.add('visible_post_update');
...
function removeModal() {
    var visibleClass = 'visible_post_update';
